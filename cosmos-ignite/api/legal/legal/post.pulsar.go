...
func init() {
	file_legal_legal_post_proto_init()
	md_Post = File_legal_legal_post_proto.Messages().ByName("Post")
...
func (x *Post) slowProtoReflect() protoreflect.Message {
	mi := &file_legal_legal_post_proto_msgTypes[0]
...
func (x *fastReflection_Post) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "legal.legal.Post.title":
		return x.Title != ""
	case "legal.legal.Post.body":
		return x.Body != ""
	case "legal.legal.Post.creator":
		return x.Creator != ""
	case "legal.legal.Post.id":
		return x.Id != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: legal.legal.Post"))
		}
		panic(fmt.Errorf("message legal.legal.Post does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Post) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message legal.legal.Post does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Post) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "legal.legal.Post.title":
		panic(fmt.Errorf("field title of message legal.legal.Post is not mutable"))
	case "legal.legal.Post.body":
		panic(fmt.Errorf("field body of message legal.legal.Post is not mutable"))
	case "legal.legal.Post.creator":
		panic(fmt.Errorf("field creator of message legal.legal.Post is not mutable"))
	case "legal.legal.Post.id":
		panic(fmt.Errorf("field id of message legal.legal.Post is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: legal.legal.Post"))
		}
...
func (x *fastReflection_Post) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in legal.legal.Post", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Post) Descriptor() ([]byte, []int) {
	return file_legal_legal_post_proto_rawDescGZIP(), []int{0}
}
...
var File_legal_legal_post_proto protoreflect.FileDescriptor

var file_legal_legal_post_proto_rawDesc = []byte{
	0x0a, 0x16, 0x6c, 0x65, 0x67, 0x61, 0x6c, 0x2f, 0x6c, 0x65, 0x67, 0x61, 0x6c, 0x2f, 0x70, 0x6f,
	0x73, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x6c, 0x65, 0x67, 0x61, 0x6c, 0x2e,
	0x6c, 0x65, 0x67, 0x61, 0x6c, 0x22, 0x5a, 0x0a, 0x04, 0x50, 0x6f, 0x73, 0x74, 0x12, 0x14, 0x0a,
	...
	,
}

var (
	file_legal_legal_post_proto_rawDescOnce sync.Once
	file_legal_legal_post_proto_rawDescData = file_legal_legal_post_proto_rawDesc
)

func file_legal_legal_post_proto_rawDescGZIP() []byte {
	file_legal_legal_post_proto_rawDescOnce.Do(func() {
		file_legal_legal_post_proto_rawDescData = protoimpl.X.CompressGZIP(file_legal_legal_post_proto_rawDescData)
	})
	return file_legal_legal_post_proto_rawDescData
}

var file_legal_legal_post_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_legal_legal_post_proto_goTypes = []interface{}{
	(*Post)(nil), // 0: legal.legal.Post
}
var file_legal_legal_post_proto_depIdxs = []int32{
...
func init() { file_legal_legal_post_proto_init() }
func file_legal_legal_post_proto_init() {
	if File_legal_legal_post_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_legal_legal_post_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Post); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_legal_legal_post_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_legal_legal_post_proto_goTypes,
		DependencyIndexes: file_legal_legal_post_proto_depIdxs,
		MessageInfos:      file_legal_legal_post_proto_msgTypes,
	}.Build()
	File_legal_legal_post_proto = out.File
	file_legal_legal_post_proto_rawDesc = nil
	file_legal_legal_post_proto_goTypes = nil
	file_legal_legal_post_proto_depIdxs = nil
}
